...
git clone https://github.com/DNSCrypt/dnscrypt-proxy.git feeds/packages/applications/dnscrypt-proxy2
...
git clone https://github.com/sbwml/luci-app-mosdns -b v5 packages/mosdns
git clone https://github.com/sbwml/v2ray-geodata packages/net/v2ray-geodata
